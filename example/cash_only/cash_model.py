...
class Model_capital(Model):
    ...
    def update(self, state, action, noise, working_capital_level, t):
        return state + action - noise, working_capital_level+self.reward(state, action, noise, t), t == self.time_horizon
